...
- Playground (/playground): koleksiyon seçip doğal dil sorusu; vektör arama + LLM yanıtı; model listesi Ollama’dan gelir.
- Loglar (/logs): alım ve sorgu izleri, hata ayıklama.

Genel kullanım: önce koleksiyon, sonra belgeleri yükle; işlem bitince Playground’da dene. Ollama adresi ve sohbet modeli sunucu ortam değişkenleriyle ayarlanır; bağlantı hatasında altyapıyı kontrol etmesini söyle.
